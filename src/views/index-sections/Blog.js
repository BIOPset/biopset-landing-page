        ...
        <Col className="ml-auto mr-auto" md="10">
          ...
          <TabContent activeTab={activeTab} className="text-center">
            ...
            <TabPane tabId="2">
              ...
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/G86wkheYmdc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </TabPane>
            <TabPane tabId="3">
              <p>The beating heart of BIOPset is our community. Please join us in Discord.</p>
              <iframe width="100%" height="100%" src="https://discord.com/widget?id=795000201742909450&theme=dark" title="BIOPset Discord Widget" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
            </TabPane>
          </TabContent>
        </Col>
      </Row>
